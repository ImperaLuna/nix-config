...
Item {
    ...
    readonly property bool hyprSpecialActiveHere: root.hyprSpecialActive && (root.hyprOpenSpecialMonitorName === root.effectiveScreenName || root.hyprOpenSpecialMonitorName === root.screenName)
    ...
    function activateHyprlandWorkspace(modelData) {
        if (!modelData?.id)
            return;
                    ...
                    onReleased: mouse => {
                        ...
                        if (mouse.button === Qt.LeftButton) {
                            if (root.useExtWorkspace && (modelData?.id || modelData?.name)) {
                                ...
                                root.activateHyprlandWorkspace(modelData);
